...
load("//web/tools:karma.bzl", "generate_karma_config", "generate_test_bootstrap", "generate_test_setup")

# Common dependencies of Angular applications
APPLICATION_DEPS = [
    "//web:node_modules/@angular/common",
    "//web:node_modules/@angular/core",
    "//web:node_modules/@angular/router",
...
TEST_DEPS = APPLICATION_DEPS + [
    ...
    "//web:node_modules/jasmine-core",
]

# Common dependencies of Angular test suites using jasmine
TEST_RUNNER_DEPS = [
    "//web:node_modules/karma-chrome-launcher",
    "//web:node_modules/karma",
    "//web:node_modules/karma-jasmine",
    "//web:node_modules/karma-jasmine-html-reporter",
    "//web:node_modules/karma-coverage",
]
