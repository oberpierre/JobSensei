...
generate_karma_config = rule(
    ...
    attrs = {
        # https://github.com/bazelbuild/rules_nodejs/blob/3.3.0/packages/concatjs_test/karma_web_test.bzl#L34-L39
        ...
        "_conf_tmpl": attr.label(
            ...
            default = Label("//web/tools:karma.conf.js"),
        ),
    },
    outputs = {
